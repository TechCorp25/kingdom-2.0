...
template. Apply `skills/task-coordination-strategies/SKILL.md` to write
...
1. Read `skills/parallel-feature-development/SKILL.md` for ownership strategy
2. Read `skills/team-composition-patterns/SKILL.md` for team sizing
...
1. Read `skills/multi-reviewer-patterns/SKILL.md` for dimension allocation
...
1. Read `skills/parallel-debugging/SKILL.md` for the ACH framework
...
`skills/team-communication-protocols/SKILL.md` anti-patterns).
...
- [ ] The matching internal skill (`skills/.../SKILL.md`) has been read
...
- `skills/team-composition-patterns/SKILL.md` — Sizing & preset selection
- `skills/parallel-feature-development/SKILL.md` — File ownership strategies
- `skills/multi-reviewer-patterns/SKILL.md` — Dimension allocation & dedup
- `skills/parallel-debugging/SKILL.md` — Analysis of Competing Hypotheses
- `skills/task-coordination-strategies/SKILL.md` — Decomposition & graphs
- `skills/team-communication-protocols/SKILL.md` — Messaging & shutdown
