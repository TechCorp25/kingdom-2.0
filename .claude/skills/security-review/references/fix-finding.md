...
Workflow
Revalidate and scope the finding.
...
Reproduce or encode the issue before fixing when feasible.
...
Implement the fix and its proof.
...
Report the outcome with exact commands, results, changed files, and remaining risk.
